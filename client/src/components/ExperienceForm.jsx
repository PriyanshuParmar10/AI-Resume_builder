...
const ExperienceForm = ({data, onChange}) => {
    ...
    const addExperience = () => {
       // Logic to add a new experience entry
        const newExperience = {
            company : "",
            position: "",
            start_date:"",
            ...
            <div className='space-y-4'>
                {data.map((experience,index)=>(
                    <div key={index} className='p-4 border border-gray-200 rounded-lg space-y-3'>
                        ...
                        <div className='grid md:grid-cols-2 gap3'>
                            ...
                            <input type="month" value={experience.end_date || ""} onChange={(e)=>updateExperience(index,'end_date',e.target.value)} disabled={experience.is_current} className='px-3 py-2 text-sm rounded-lg disabled:bg-gray-100'/>
                        </div>
